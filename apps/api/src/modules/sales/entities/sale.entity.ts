...
export class SaleEntity {
  ...
  @Column({ type: 'varchar', length: 50, name: 'terminal_id' })
  terminalId: string;
  ...
  @Column({ type: 'decimal', precision: 14, scale: 2, name: 'discount_amount', default: 0 })
  discountAmount: number;

  @Column({ type: 'varchar', length: 20, name: 'discount_type', nullable: true })
  discountType: string | null;

  @Column({ type: 'decimal', precision: 14, scale: 2, name: 'discount_value', default: 0 })
  discountValue: number;

  @Column({ type: 'decimal', precision: 14, scale: 2, name: 'tax_amount', default: 0 })
  taxAmount: number;
  ...
  @Column({ type: 'decimal', precision: 14, scale: 2, name: 'cash_received', nullable: true })
  cashReceived: number | null;

  @Column({ type: 'decimal', precision: 14, scale: 2, name: 'change_amount', nullable: true })
  changeAmount: number | null;

  @Column({ type: 'int', name: 'loyalty_earned', default: 0 })
  loyaltyEarned: number;

  @Column({ type: 'int', name: 'loyalty_redeemed', default: 0 })
...
export class SaleItemEntity {
  ...
  @Column({ type: 'varchar', length: 50, name: 'product_barcode', nullable: true })
